...
## M03_Assn1_Ex21 extra credit
## 1/29/21
## Program written to play rock paper scissors lizard spock vs an AI opponent
...
# importing random module for using random.randrange
import random
...
def main(guess): 
    ...
    # assign random guess for comp_number using random.randrange()
    comp_number = random.randrange(0,5)

    # calculate difference of player_number and comp_number
    ...
    # convert comp_number to name using number_to_name function
